...
class Cube extends Square {
    ...
    public Cube(double s1, String name){
	super(s1,name);
    }
    public double getArea() {
...
public class TestFigures{
	...
	System.out.println(cube.toString() + ": side1 " + cube.getSide1() + " Area" + cube.getArea() + " Perimeter" + cube.getPerimeter());
	if(rect.equals(circle)){
	    System.out.println("rect and circle are equal.");
	}
	else{
	    System.out.println("rect and circle are not equal.");
	}
	if(rect.equals(rect)){
	    System.out.println("rect and rect are equal.");
	}
	else{
	    System.out.println("rect and rect are not equal.");
	}
    }
}